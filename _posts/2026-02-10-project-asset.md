...
Finally, to adapt to complex task environments in reality, I added a feature that calls Rodin for 3D model generation (which is relatively accurate in physical structure and basically reasonable in textures), and the generated models are processed as simple concave objects.